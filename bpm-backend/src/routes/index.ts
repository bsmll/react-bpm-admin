...
router.get(
  "/process-definitions",
  authMiddleware,
  processController.getDefinitions,
);
router.post(
  "/process-definitions",
  authMiddleware,
  processController.createDefinition,
);
router.put(
  "/process-definitions/:id",
  authMiddleware,
  processController.updateDefinition,
);
router.post(
  "/process-definitions/:id/publish",
  authMiddleware,
  processController.publishDefinition,
);
router.delete(
  "/process-definitions/:id",
  authMiddleware,
  processController.deleteDefinition,
);
...
router.post(
  ...
  authMiddleware,
  instanceController.cancelInstance,
);
...
router.get(
  "/tasks/my-pending",
  authMiddleware,
  taskController.getMyPendingTasks,
);
...
router.post(
  "/test/notification",
  authMiddleware,
  testController.sendTestNotification,
);

router.post("/ai/generate-form", authMiddleware, aiController.generateForm);
